...
def add_SourceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'next_order': grpc.unary_unary_rpc_method_handler(
          ...
          response_serializer=simulation__pb2.Time.SerializeToString,
      ),
      'get_part': grpc.unary_unary_rpc_method_handler(
          servicer.get_part,
          request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
          response_serializer=simulation__pb2.Data.SerializeToString,
      ),
...
def add_VehicleServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'get_eta': grpc.unary_unary_rpc_method_handler(
          servicer.get_eta,
          request_deserializer=simulation__pb2.Data.FromString,
          response_serializer=simulation__pb2.Time.SerializeToString,
      ),
